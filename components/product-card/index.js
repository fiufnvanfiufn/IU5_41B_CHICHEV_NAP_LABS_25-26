export class ProductCardComponent {
    ...
    getHTML(data) {
        return `
            <div class="col">
                <div class="card h-100 shadow" style="background-color: #141212; border: 2px solid #4b4d8a; border-radius: 20px; color: #d1d1e9;">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto d-flex flex-column gap-2">
                            <button class="btn btn-sm w-100" id="click-card-${data.id}" data-id="${data.id}" style="background-color: #ffffff; color: #050714; font-weight: bold; border: none; border-radius: 10px; height: 35px;">
                                Подробнее
                            </button>
